...
begin
    some_api.setup   (in_department_id => constants_up.k_DEPT_ADMIN);
    some_api.process (in_department_id => constants_up.k_DEPT_ADMIN);
    some_api.teardown(in_department_id => constants_up.k_DEPT_ADMIN);
end;
/
```
