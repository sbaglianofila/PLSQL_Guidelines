...
declare
    co_dob_str  constant    varchar2(10 char) := '1971-03-23';
    l_date                  date;
begin
    l_date := to_date(co_dob_str default null on conversion error);
end;
/
```
...
declare
    co_salary   constant    varchar2(10 char) := '2500.00';
    l_salary                employees.salary%type;
begin
    l_salary := to_number(co_salary default null on conversion error);
end;
/
```
...
declare
    co_dob_str  constant    varchar2(10 char) := 'not-a-date';
    l_date                  date;
begin
    begin
        l_date := to_date(co_dob_str, 'FXYYYY-MM-DD');
    exception
        when others then
            l_date := null;
    end;
