prompt File: orders_audit_trg.trg.sql <start>
-- =============================================================================
-- File:     orders_audit_trg.trg.sql
-- Object:   ORDERS_AUDIT_TRG (trigger)
-- Schema:   #APP# (owner)
-- Purpose:  Maintains the standard administrative columns of ORDERS:
...
prompt ORDERS_AUDIT_TRG: Creating trigger
...
/
show errors trigger orders_audit_trg

prompt File: orders_audit_trg.trg.sql <end>
